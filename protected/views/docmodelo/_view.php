<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('cabecalho_id')); ?>:</b>
	<?php echo CHtml::encode($data->cabecalho_id); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('rodape_id')); ?>:</b>
	<?php echo CHtml::encode($data->rodape_id); ?>
	<br />

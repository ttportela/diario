...
class ParecerController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Parecer']))
		{
			$model->attributes=$_POST['Parecer'];
			if($model->save())
	...
	{
		/*$dataProvider=new CActiveDataProvider('Parecer');
		$this->render('index',array(
			'dataProvider'=>$dataProvider,
		));*/
		
		$model=new Parecer('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Parecer']))
			$model->attributes=$_GET['Parecer'];
	...
	{
		$model=Parecer::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='parecer-form')
		{

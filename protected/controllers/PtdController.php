...
class PtdController extends Controller
{
	...
	{
		/*$dataProvider=new CActiveDataProvider('PTD');
		$this->render('index',array(
			'dataProvider'=>$dataProvider,
		));*/
		
		$model=new PTD('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PTD']))
			$model->attributes=$_GET['PTD'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ptd-form')
		{

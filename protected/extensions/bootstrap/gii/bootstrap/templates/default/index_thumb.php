...
echo "\$this->breadcrumbs=array(
	Yii::t('model', 'model.".strtolower($this->modelClass)."', 2)=>array('index'),
...
<div class="page-header">
  <h3><?php echo "<?php echo Yii::t('model', 'model.".strtolower($this->modelClass)."', 2); ?>"; ?>
  <small><?php echo "<?php echo Yii::t('app', 'app.crud.label.index'); ?>"; ?></small></h3>
</div>

<?php echo "<?php echo CHtml::link(Yii::t('app', 'app.crud.label.advancedsearch'),'#',array('class'=>'search-button btn')); ?>"; ?>
